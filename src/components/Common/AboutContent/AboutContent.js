      ...
      </p>
      {
        small ? null : (
          <>
            ...
            <p className={styles.paragraph}>
              Besides work, I love music, at the moment I am listening to <LatestTrack/>. I also love travelling, for memories like [this], although I haven't done it as much as I'd want.
            </p>
            <p className={styles.paragraph}>
