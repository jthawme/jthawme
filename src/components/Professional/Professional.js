  ...
  return (
    <main className={"page"}>
      <Row
        ...
        <p className="large">
          I have been a <span className="highlight">Web Developer</span> for <span className="little-dev-joke">(new Date().getFullYear() - 2011) =</span> <span className="highlight">{ totalYears } years</span> now and have worked on projects small and large, in studios small and large.
        </p>
        <p className="large">
      ...
      <Row
        ...
        <Row
          ...
          <BigList>
            {
              noteworthy.map(({ title, subtitle, info, date, file }, idx) => {
